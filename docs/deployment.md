...
> **단일 프로젝트 정책 (2026-07-01 결정)**: dev 환경은 로컬 Docker Supabase, staging/prod 환경은 단일 클라우드 프로젝트(lqltwbpocbgoxvhlmjdo)를 공유한다. staging/prod 구분은 ENV flag 및 Sentry DSN으로만 수행한다. 별도 클라우드 프로젝트 생성은 MVP 이후 검토.
