...
const styles = StyleSheet.create({
  ...
  card: { gap: spacing[2] },
  clubTitle: { fontSize: typography.headingMd.fontSize, fontWeight: typography.headingMd.fontWeight },
  description: { fontSize: typography.bodyMd.fontSize },
  metaRow: { flexDirection: 'row', gap: spacing[3], marginTop: 4 },
  meta: { fontSize: typography.sectionLabel.fontSize, fontWeight: typography.sectionLabel.fontWeight },
  sectionTitle: { fontSize: typography.headingSm.fontSize, fontWeight: typography.headingSm.fontWeight, marginBottom: spacing[2] },
  sectionLabel: { fontSize: typography.sectionLabel.fontSize, fontWeight: typography.sectionLabel.fontWeight },
  ...
  emptyText: { fontSize: typography.bodyMd.fontSize, marginTop: spacing[2] },
  memberRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  },
  memberName: { fontSize: typography.ctaLabel.fontSize, fontWeight: typography.ctaLabel.fontWeight, flexShrink: 1 },
  roleBadge: { fontSize: typography.caption.fontSize, fontWeight: typography.ctaLabel.fontWeight },
  secondaryButton: { paddingVertical: spacing[3], alignItems: 'center' },
  secondaryButtonText: { fontSize: typography.ctaLabel.fontSize, fontWeight: typography.headingMd.fontWeight },
  dangerButton: { paddingVertical: spacing[3], alignItems: 'center', borderWidth: borderWidth.hairline },
  dangerButtonText: { fontSize: typography.ctaLabel.fontSize, fontWeight: typography.headingMd.fontWeight },
});
