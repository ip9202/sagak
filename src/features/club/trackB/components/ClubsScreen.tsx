...
const styles = StyleSheet.create({
  ...
  retryButton: { paddingVertical: spacing[3], paddingHorizontal: spacing[5] },
  retryText: { fontSize: typography.ctaLabel.fontSize, fontWeight: typography.ctaLabel.fontWeight },
  list: { flex: 1 },
  listContent: { gap: spacing[4], paddingTop: spacing[1] },
  section: { fontSize: typography.sectionLabel.fontSize, fontWeight: typography.sectionLabel.fontWeight },
  emptyCard: { gap: spacing[2] },
  emptyTitle: { fontSize: typography.headingMd.fontSize, fontWeight: typography.headingMd.fontWeight },
  emptyHint: { fontSize: typography.bodyMd.fontSize },
  card: {
    flexDirection: 'row',
    gap: spacing[3],
  ...
  clubTitle: { fontSize: typography.alarmTitle.fontSize, fontWeight: typography.alarmTitle.fontWeight },
  meta: { fontSize: typography.caption.fontSize },
  status: { fontSize: typography.caption.fontSize, fontWeight: typography.ctaLabel.fontWeight },
  ctaButton: { paddingVertical: 14, alignItems: 'center' },
  ctaText: { fontSize: typography.alarmTitle.fontSize, fontWeight: typography.headingMd.fontWeight },
  createIcon: { alignItems: 'center', justifyContent: 'center' },
  createIconText: { fontSize: 26, fontWeight: typography.bodyPrompt.fontWeight, lineHeight: 28 },
});
