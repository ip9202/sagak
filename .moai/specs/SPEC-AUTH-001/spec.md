...
- **OAuth 제공자**: v1.0.0(2026-06-15)에서는 kakao/apple/google로 구현됨. v1.0.1(2026-06-17)에서 네이버로 변경 반영 필요 (REQ-AUTH-001 AuthProvider 타입, 버튼 라벨, UI)
...
**v1.0.1 변경사항**:
- OAuth 제공자: apple → naver (한국 시장 주류 조합, App Store 4.8 한국 예외 적용)
- 네이버 연동: Supabase Custom OIDC(2026년 6월 기능)로 구현 가정
- 미결정 사항 5.3 해결: Apple 제외 확정
