...
> **철회 공지 (2026-07-07, PR #140)**: 사용자 결정으로 Sentry 통합 제거. REQ-DEPLOY-014~017 무효. 해당 REQ의 인수 기준(AC-DEPLOY-014~017)도 무효.
...
| 2026-07-07 | 1.0.2  | **철회**: Sentry 인수 기준(AC-DEPLOY-014~017) 무효. 사용자 결정으로 Sentry 통합 제거 (PR #140). | 강력쇠주먹 |
