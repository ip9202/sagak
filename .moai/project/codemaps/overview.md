...
## 구현 완료 모듈 (2026-06-15 업데이트)

**SPEC-API-001 (백엔드 통합 파운데이션)**:
- `src/config/` — 환경 변수 검증 모듈
- `src/lib/supabase/` — Supabase 클라이언트 싱글톤 및 세션 저장소
- `src/lib/api/` — API 에러 처리 파이프라인 및 Edge Function 래퍼
