...
- M3 — Sentry SDK 통합 (@sentry/react-native ~7.11.0 설치 완료, app/_layout.tsx에서 initSentry 호출, getSentryConfigInput 헬퍼 추가, 방어 깊이: .catch() + DSN trim(). source-map/upload 제외)
